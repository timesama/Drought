...
export default class SceneSix extends Phaser.Scene{
    constructor(){
        super('SceneSix')
    }
    preload(){
    ...
    loadAssets(){
        ...
        this.load.spritesheet('Installator2_idle', 'assets/spritesheet/Installator2_idle.png', {
            frameWidth,
            frameHeight
        });
    ...
    loadAnimation(){
        ...
        this.anims.create({
            key: 'Installator2_idle',
            frames: this.anims.generateFrameNumbers('Installator2_idle', {start:0, end:1}),
            frameRate: 4,
            repeat: -1
        })
    }
    ...
    grannyAnimation(x,y){
        this.grannySprite = this.add.sprite(x,y, 'Installator2_idle')
        .setScale(10*this.scaleFactor)
        .setDepth(10)
        .setFlipX(true)
    }
    ...
    createDictionary(){
        this.Dictionary = [
            {
                text: "Colleague! Finally you are here!",
                speaker: 'client'
            },
            {
                text: "This sounds like a lot of troubles.",
                speaker: 'moti'
            },
            {
                text: "It is what it sounds like.\nI need your help\nI can't do it alone",
                speaker: 'client'
            },
            {
                text: "Okay, let's take a look",
                speaker: 'moti'
            },
            {
    ...
    animateText(){
        ...
        if (speaker === 'client'){
            this.grannySprite.play('Installator2_idle')
            this.installatorSprite.anims.stop(true)
            this.game.events.emit('playSoundSpeak', 'installator2')
        }
    ...
    pauseButton(){
        ...
        pause_button.on('pointerdown', () => {
            this.game.events.emit('buttonClicks')
            this.scene.launch('Pause', { param: 'SceneSix' })

            if (!this.multiPlayerState) {this.scene.pause('SceneSix')}
        })
    }
